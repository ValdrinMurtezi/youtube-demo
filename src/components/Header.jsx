...
function Header() {
  return (
    <div className="w-full flex flex-col navbar bg-[#ffffffde]">
      <div className=" w-full h-[3.5rem] flex items-center justify-end pr-8 space-x-[6rem]">
        <div className="w-[70%] h-[2.5rem] flex items-center">
          ...
          />
          <button className="w-[10%] flex items-center px-4 justify-center hover:bg-[#bbbdbb3d] bg-[#c9c8c82a] border-[#80808077] border-[1px] border-l-0 h-full">
