...
function Tags() {
  return (
    <div className="tags z-[99] sticky top-[55px] min-h-[3.5rem] py-1 pl-auto md:pl-[35rem] lg:pl-[1rem] border-y-[1px] flex items-center justify-center md:justify-start ">
