...
function Tags() {
  return (
    <div className="tags z-[99] sticky top-[56px] min-h-[3.5rem] py-1 pl-[1rem] md:pl-[35rem] lg:pl-[1rem] border-y-[1px] flex items-center justify-start md:justify-start ">
